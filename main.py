...
def SimCLR_main():
    ...
    agent.SimCLR_classifier_finetune(model_state_dict=f"./CheckPoints/ResNet50_{args.width_multiplier}/backbone_checkpoint_{args.epochs}_{args.width_multiplier}.pt")
